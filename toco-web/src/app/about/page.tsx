    ...
    <main className="flex flex-col items-center justify-center min-h-screen text-black p-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-2 gap-12 text-left mb-12">
          <div>
            <h2 className="text-3xl font-bold mb-4">El Proceso</h2>
          ...
          <div>
            <h2 className="text-3xl font-bold mb-4">El Kit TOCO</h2>
        ...
        <div>
          <h2 className="text-3xl font-bold mb-4">¿Por qué TOCO?</h2>
