    ...
    <main className="flex flex-col items-center justify-center min-h-screen text-black p-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-2 gap-12 text-left mb-12">
          <div>
            <h2 className="text-3xl font-bold mb-4">Distribuidores Independientes</h2>
          ...
          <div>
            <h2 className="text-3xl font-bold mb-4">Representantes y Socios</h2>
        ...
        <div className="bg-gray-100 p-8 rounded-lg text-left">
          <h2 className="text-3xl font-bold mb-4 text-center">Cómo Empezar</h2>
          <ol className="relative border-l border-gray-300 dark:border-gray-700">
            <li className="mb-10 ml-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900">1. Registrate</h3>
