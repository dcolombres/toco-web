    ...
    <main className="flex flex-col items-center justify-center min-h-screen text-black p-24">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-2 gap-16 text-left mb-16">
          <div>
            <h2 className="text-3xl font-bold mb-6">Alianzas con ONGs Ambientales</h2>
          ...
          <div>
            <h2 className="text-3xl font-bold mb-6">Alianzas con Empresas (RSE)</h2>
          ...
          <div>
            <h2 className="text-3xl font-bold mb-6">Alianzas con Gobiernos y Municipios</h2>
          ...
          <div>
            <h2 className="text-3xl font-bold mb-6">Alianzas con Influencers y Medios</h2>
        ...
        <div className="bg-gray-100 p-12 rounded-lg text-center">
          <h2 className="text-3xl font-bold mb-6">¿Querés ser nuestro aliado?</h2>
